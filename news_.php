...
if($poisk['count'] > '0') {
		$out.= '<td class="calendar-day ' . $class . '"><a href="/newsort/' . $day.'-'.$month.'-'.$year.'">' . $day . '</a></td>';
...
<div class="bread"><a href="/">Главная</a> / Новости </div>
...
$poisk = $db->super_query( "SELECT count(*) as count FROM news  " );	
}
...
while ( $i = $db->get_row( $sql_ordersf ) ) {
echo '
<div class="nb">
<div class="pic"><img src="/pic/'.$i['pic'].'"></div>
